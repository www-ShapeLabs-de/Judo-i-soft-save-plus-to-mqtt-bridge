...
#Judo Config
JUDO_USER = "Henning"
JUDO_PASSWORD = "test123"

#MQTT Config
BROKER = "192.168.2.5"							#Broker IP
...
#General Config
LOCATION = "Keller"								#Location of Judo device
NAME = "Judo_isoftsaveplusxyz"						#Name of Judo device
...
APPDAEMON = False                                #'True' , if running in Appdaemon docker directly in HA, on generic Linux platform set flag to 'False'
