...
# The maximum slider values can be set for leakage protection can be limited here
# The limitation can be useful to improve the handling of the sliders in homeassistant
LIMIT_EXTRACTION_TIME = 60           #can be setup to max 600min
LIMIT_MAX_WATERFLOW = 3000           #can be setup to max 5000L/h
LIMIT_EXTRACTION_QUANTITY = 500      #can be setup to max 3000L

#Eviroment Settings
APPDAEMON = True                     #True, if running in Appdaemon docker directly in HA
